...
export async function fetchPosts(pageNumber=1, pageSize = 20) {
 ...
 //fetch the posts that have no parents(posts except comments)
 ...
 const posts=await postsQuery.exec(); //exec= execute
...
export async function addCommentToThread(
    ...
    path: string,
        ...
        try{const originalThread =await Thread.findById(threadId);
